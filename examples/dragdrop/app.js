  ...
  */
  ...
  Uppy.prototype.actions = function actions() {
    ...
    this.on('upload-started', function (fileID, upload) {
      if (!_this4.getFile(fileID)) {
        _this4.log('Not setting progress for a file that has been removed: ' + fileID);
        return;
      }
    ...
    this.on('upload-success', function (file, uploadResp, uploadURL) {
      _this4.setFileState(file.id, {
        progress: _extends({}, _this4.state.files[file.id].progress, {
          uploadComplete: true,
          percentage: 100
        }),
        uploadURL: uploadURL,
